...
plt_outdir<-"out/20200512/" # directory for output

ylimD<-c(20,20,20,5,50,20,20,10,30,20)
ylimC<-c(300,200,200,100,1000,300,20,50,400,150)
ylimH<-c(800,500,1000,500,1500,1000,70,100,1000,500)
...
for (n in c(2,3,6,7,9,10)) {

  load(paste('StateSpace_District',n,'.RData',sep=""))
  ...
  # print( ggplot(D.frame,aes(x=LiftReduction1))+geom_histogram(binwidth=0.05)+xlim(0.0,0.7) )+ggtitle(paste('district',n))
...
#for (n in 8) {
  ...
  # print( ggplot(D.frame,aes(x=LiftReduction2))+geom_histogram(binwidth=0.05)+xlim(0.0,0.7) )+ggtitle(paste('district',n))
  # ggsave(paste(plt_outdir,"district",n,"_plt8.png",sep=""))
  # print( ggplot(D.frame,aes(x=HospRate))+geom_histogram(binwidth=0.005)+xlim(Rhosp_vec[1],Rhosp_vec[length(Rhosp_vec)]))+ggtitle(paste('district',n))
  # ggsave(paste(plt_outdir,"district",n,"_plt9.png",sep=""))
  # print( ggplot(D.frame,aes(x=CritRate))+geom_histogram(binwidth=0.001)+xlim(Rcrit_vec[1],Rcrit_vec[length(Rcrit_vec)]) )+ggtitle(paste('district',n))
