...
for (t in 1:maxt) {
  ...
  StateSpace[lift_rdxn_i,lift_rdxn_j,Rhosp_vec_i,Rcrit_vec_i,7,t]=StageThreeReductionA
  StateSpace[lift_rdxn_i,lift_rdxn_j,Rhosp_vec_i,Rcrit_vec_i,8,t]=StageFourReduction
}
