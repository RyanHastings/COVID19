...
lift_rdxn_vec<-seq(0.35,0.7,0.05)
...
StateSpace_filename<-"StateSpace_stage3.Rdata"#StateSpace_day65_detailRcrit.Rdata" #_expanded.Rdata"
...
K=50
dt=1.0
outdir<-"../../../COVID19Response/model_v3.0_out/out/20200609/"
...
ggsave(paste(outdir,"StatewideLiftReduction1Hist.png",sep=""))
print( ggplot(D.frame,aes(x=LiftReduction2))+geom_histogram(binwidth=0.05)+xlim(0.0,0.7) )
ggsave(paste(outdir,"StatewideLiftReduction2Hist.png",sep=""))
...
#          xlim(death_date1-7,death_date2+14)+ylim(0,ylimD)+
#          geom_ribbon(data=df.MaxMin,aes(x=Dates,ymin=MinDeath,ymax=MaxDeath),fill="red",alpha="0.5")+
#          ylab("Deaths per Day")+ggtitle("Two Week Projection")
# )
# ggsave(paste(outdir,"StatewideDeathMaxMin2weeks.png",sep=""))
...
#          xlim(hosp_date1-7,hosp_date2+14)+ylim(0,ylimH)+
#          geom_ribbon(data=df.MaxMin,aes(x=Dates,ymin=MinHosp,ymax=MaxHosp),fill="red",alpha="0.5")+
#          ylab("Hospitalized")+ggtitle("Two Week Projection")
# )
# ggsave(paste(outdir,"StatewideHospMaxMin2weeks.png",sep=""))
...
#          xlim(hosp_date1-7,hosp_date2+14)+ylim(0,ylimC)+
#          ylab("ICU beds")+ggtitle("Two Week Projection")
# )
# ggsave(paste(outdir,"StatewideCritMaxMin2weeks.png",sep=""))
# 
# # plot max and min
# print( ggplot()+geom_point(data=df.deaths,aes(x=Dates,y=DeathCount))+
#          geom_line(data=df.MaxMin,aes(x=Dates,y=MaxDeath))+
