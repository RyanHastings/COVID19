...
for (t in 2:maxt) {
  ...
  } else if (t>=StageFiveDay & t<StageFiveDay+stage5_weeks*7) {
    Rt<-R0*(1-StageFourReduction*(stage5_weeks*7-(t-StageFiveDay))/(stage5_weeks*7))
    Rhosp<-RhospStageFour
    Rcrit<-RcritStageFour
    # print(t-PhaseFiveDay)
    # print((stage5_weeks*7-(t-PhaseFiveDay))/(stage5_weeks*7))
    # print(Rt)
  } else if (t>=StageFiveDay+stage5_weeks*7) {
    Rt<-R0
    Rhosp<-RhospStageFour
    Rcrit<-RcritStageFour
  }
